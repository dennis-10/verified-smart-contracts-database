...
contract TBL is ERC1155Tradable {
	constructor() public ERC1155Tradable("Treasure Bowl", "TBL") {
		_setBaseMetadataURI("https://raw.githubusercontent.com/chaebolService/testnet_metadata/main/cle/");
	}
