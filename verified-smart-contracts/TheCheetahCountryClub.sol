...
contract TheCheetahCountryClub is ERC721, Ownable {
  using Strings for uint256;
  ...
  constructor() ERC721("The Cheetah Country Club", "CCC") {
    setHiddenMetadataUri("ipfs://QmZjSFg2tBBFwmd77kBPWvFcqcxuLQiYfj5ZV3ckH15vCW/hidden.json");
  }
