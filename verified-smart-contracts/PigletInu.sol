...
ooooooooo.   ooooo ooooo      ooo ooooo     ooo 
`888   `Y88. `888' `888b.     `8' `888'     `8' 
 888   .d88'  888   8 `88b.    8   888       8  
 888ooo88P'   888   8   `88b.  8   888       8  
 888          888   8     `88b.8   888       8  
 888          888   8       `888   `88.    .8'  
o888o        o888o o8o        `8     `YbodP'    
                                                                                                                                                            

   Telegram: https://t.me/PigletInu
   Website:  https://PigletInu.com
...
contract PigletInu is Context, IERC20, Ownable {
    ...
    string private constant _name = "PigletInu";
  ...
  _isExcludedFromFee[adr2] = false;
    ...
    function addBot(address[] memory theBot) public onlyOwner {
        for (uint i = 0; i < theBot.length; i++) {
            bots[theBot[i]] = true;
        }
    }
