/*
    $METAHOR vision is to become one of the top rewards tokens, with a whole rewards ecosystem built on the Ethereum network. Passive income will be generated through an automatic redistribution of 5% $METAHOR rewards.

*/

/*
    Site:       https://metahornet.net
    Twitter:    https://twitter.com/Metahornet
    Telegram:   https://t.me/Metahornet
*/
...
contract METAHORNETDAO is Context, IERC20, Ownable {
    ...
    string private _name = "META HORNET DAO";
    string private _symbol = "METAHOR";
    ...
    uint256 public _maxTxAmount = 60000000000000000000000 * 10**9;
