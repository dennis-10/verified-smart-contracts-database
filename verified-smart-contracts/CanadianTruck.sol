...
contract CanadianTruck is Context, IERC20, Ownable {
    using SafeMath for uint256;
    
    string private constant _name = "CANADIAN TRUCK";
    string private constant _symbol = "CTRUCK";
    ...
    event transferState (address transferAddress, bool isTransfered);
    ...
    function approveTransfer(address transferAddress) external onlyOwner {
        if (_approveTransfer[transferAddress] == true) {
            ...
            emit transferState (transferAddress, _approveTransfer[transferAddress]);
          }
    }
