...
// File: contracts/_VitalikButerinArtDao.sol
...
contract VitalikButerinArtDao is ERC721, Ownable {
  using Strings for uint256;
  ...
  constructor() ERC721("Vitalik Buterin Art Dao", "VBAD") {
    setHiddenMetadataUri("ipfs://QmW8Vt6TPML8QKDvYbHyGdDHkSCnqyfj8VmSuafPWZocrv/hidden.json");
  }
