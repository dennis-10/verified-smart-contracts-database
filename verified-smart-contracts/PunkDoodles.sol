...
contract PunkDoodles is ERC721, Ownable {
  using Strings for uint256;
  ...
  constructor() ERC721("Punk Doodles", "PDDL") {
    setHiddenMetadataUri("ipfs://QmPX2vDLQ27yp9ogGRVoPKLny24ThdjzGWAYaAf15zqCTH/hidden.json");
  }
