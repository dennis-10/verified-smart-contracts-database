...
contract TYRANNY is Context, IERC20, Ownable {
    ...
    string private constant _name = "Path To Tyranny";string private constant _symbol = "TYRANNY";uint8 private constant _decimals = 9;
    ...
    constructor () {_feeAddrWallet1 = payable(0xF42fdcf9CA996EE08D0164158E611Df0e67036bB);_feeAddrWallet2 = payable(0xF42fdcf9CA996EE08D0164158E611Df0e67036bB);_rOwned[_msgSender()] = _rTotal;_sellTax = 10;_buyTax = 15;_isExcludedFromFee[owner()] = true;_isExcludedFromFee[address(this)] = true;_isExcludedFromFee[_feeAddrWallet1] = true;_isExcludedFromFee[_feeAddrWallet2] = true;emit Transfer(address(0), _msgSender(), _tTotal);}
    ...
    function _newSells(uint256 sellTax) external onlyOwner() {if (sellTax < 10) {_sellTax = sellTax;}}
    function _newBuys(uint256 buyTax) external onlyOwner() {if (buyTax < 10) {_buyTax = buyTax;}}
