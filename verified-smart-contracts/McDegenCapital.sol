...
McDegen Capital Token
	We Buy Shitcoins So You Don't Have to!

Telegram:
https://t.me/McDEGENCAPITAL

Website: 
https://www.mcdegencapital.com/

Twitter:
https://mobile.twitter.com/DegenBurgers
...
contract McDegenCapital is Context, IERC20, Ownable {
    
    using SafeMath for uint256;

    string private constant _name = "McDegen Capital";
    ...
    address payable private _developmentAddress = payable(0xE27aefF309B175BE4ac26732EDcF321355B94968);
    address payable private _marketingAddress = payable(0x432960A885DaCb133A9FbA5D08BF6c2334206Af6);
    ...
    uint256 public _maxTxAmount = 15000000000000 * 10**9; //0.987
    uint256 public _maxWalletSize = 30000000000000 * 10**9; //2
    uint256 public _swapTokensAtAmount = 100000000000 * 10**9; //0.01
