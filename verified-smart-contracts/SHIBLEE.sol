...
contract SHIBLEE is Context, IERC20, Ownable {
    ...
    string private _name = "ShibLee";
    string private _symbol = "SHIBLEE";
    ...
    uint256 public _maxTxAmount = 417900000000000000000 * 10**9;
    uint256 public numTokensSellToAddToLiquidity = 1000000000000000000000 * 10**9;
    uint256 public _maxWalletSize = 735000000000000000000 * 10**9;
