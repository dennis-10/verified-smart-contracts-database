...
/// @title Gangs Of Yorks
/// @custom:security-contact security@redbuildinggroup.com
contract GangsOfYorks is ERC721, ERC721Enumerable, Pausable, Ownable, ERC721Burnable {
    ...
    constructor(string memory _initBaseURI) ERC721("GangsOfYorks", "YRKI") {
        // sets BaseURI
    ...
    */
    function mint(uint256 _mintAmount) public payable {
        require(balanceOf(msg.sender) <= 14, "Only 15 mints allowed per account");
