...
// File contracts/EttiosToken.sol
...
contract EttiosToken is ERC20Upgradeable {
    address payable public _owner;
    // string constant _sym = "ETT";
    // string constant _name = "Ettios";
    ...
    // Initializer function (replaces constructor)
    function initialize(string memory symbol, string memory name)
        external
        initializer
    {
        _owner = payable(_msgSender());
