...
// File: contract/main.sol


// Title:  Crypto Takeover - COA via Pest Control
// Medium: NFT
// Year: 2022
// Size: 1280 x 1280
// Notes: None
...
contract cryptoTakeover is ERC721, Ownable {
  ...
  constructor(string memory baseURI)
    ERC721("CryptoTakeover", "Crypto Takeover Edition 1")
  {
    setBaseURI(baseURI);
  }
  ...
  function Mint(uint256 num) public payable {
    ...
    if (totalSupply + num > maxF && isFlipState) {
      require(num < 3, "MAX PER TRANSACTION IS 30");
      require(msg.value >= price * num, "NOT ENOUGH ETH");
    } else {
      require(
        freeWallets[msg.sender] + num < 3,
  ...
  function setMaxF(uint256 newMaxF) public onlyOwner {
    maxF = newMaxF;
  }
...
//I hate this medium.  Percentage of mint will be donated to charity.