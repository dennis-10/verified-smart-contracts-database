...
contract DikDiks is ERC721Enumerable, Ownable {
  using Strings for uint256;
  string baseURI;
  ...
  bool public locked;
  event Play2Earn(uint256 nftID, uint256 value, uint256 actionID, string payload);
  ...
  // admin can mint them for giveaways, airdrops etc
    ...
    function customThing(
        ...
        emit Play2Earn(nftID, msg.value, id, what);
    }
