...
/**
 *  
 *  McElon is a meme token based on Elon’s tweet
 *  
 *  https://t.me/McElonERC
 *  
 *  https://mcelon.xyz
 *  
 *  Buy tax: 4%
...
contract MCELON is Context, IERC20, Auth {
    using SafeMath for uint256;
    string private constant _name = "McElon.xyz";
    string private constant _symbol = "McElon";
